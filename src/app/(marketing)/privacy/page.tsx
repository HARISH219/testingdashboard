...
export const metadata = { title: "Privacy Policy — Snowy" };
  ...
  return (
    <div className="container max-w-3xl py-16">
      ...
      <div className="prose prose-invert mt-8 space-y-4 text-frost">
        <p>Snowy stores only the data required to provide the dashboard: your Discord user id, username, avatar, and the guilds you can manage. Access tokens are kept in a secure server-side session and never exposed to the browser.</p>
